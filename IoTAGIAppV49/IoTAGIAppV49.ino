...
// ======================================================================
// Embedded RGB565 icons (inlined from icons_rgb565_V1.h)
// หมายเหตุ: ฝังข้อมูลไอคอนไว้ในไฟล์ library โดยตรง เพื่อลดปัญหา Arduino IDE
// มองไม่เห็นไฟล์ header หรือชื่อ array ไม่ถูกประกาศขณะคอมไพล์
// ======================================================================
